...
<?php
    ...
    for ($i = 0;$i < count($log)-1;$i++) {
        ...
        echo '<tr><td><code>用户认证客户端用户名</code></td><td><code>' . $split[1] . '</code></td></tr>';
        ...
        echo '<tr><td><code>Referer</code></td><td><code>' . $split[6] . '</code></td></tr>';
        echo '<tr><td><code>UA</code></td><td><code>' . $split[7] . '</code></td></tr>';
        echo '<tr><td><code>真实IP</code></td><td><code>' . $split[8] . '</code></td></tr>';
        echo '<tr><td><code>SSL协议</code></td><td><code>' . $split[9] . '</code></td></tr>';
        echo '<tr><td><code>SSL密码</code></td><td><code>' . $split[10] . '</code></td></tr>';
